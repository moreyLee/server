...
func (b *BaseApi) Domain(c *gin.Context) {
	...
	commandStr := "curl -X POST -H \"X-Auth-Key:0237bd44ec3b541e622d6aa1b187aac9193f0\" -H \"X-Auth-Email:djpt36@163.com\" -H \"Content-Type: application/json\" \"https://api.cloudflare.com/client/v4/zones\" --data '{\"name\":\"ss36.vip\",\"jump_start\":\"true\"}'"
	// 创建域名
